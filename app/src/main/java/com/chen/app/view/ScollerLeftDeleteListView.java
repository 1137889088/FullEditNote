...
public class ScollerLeftDeleteListView extends ListView {
    ...
    public ScollerLeftDeleteListView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ScollerLeftDeleteListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void performActionDown(MotionEvent ev) {
        ...
        // 获取删除按钮的宽度
        if (mPointChild != null) {
            mDeleteBtnWidth = mPointChild.getChildAt(1).getLayoutParams().width * 2;
