...
public class ColorPickerDialog extends Dialog {
	 ...
	 *            回调
	 */
	public ColorPickerDialog(Context context, int theme, int initialColor, OnColorChangedListener listener) {
		super(context, theme);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int height = (int)(manager.getDefaultDisplay().getWidth() * 0.7f);
